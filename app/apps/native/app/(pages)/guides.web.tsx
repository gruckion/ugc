...
const POPULAR_GUIDES = [
  {
    id: "1",
    title: "Getting Started with UGC",
  ...
  { id: "3", title: "Building a Portfolio", href: "/guides/portfolio" },
  {
    ...
    href: "/guides/working-with-brands",
  },
...
export default function GuidesPage() {
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <ScrollView>
        <View
          className="mx-auto w-full max-w-[1200px] gap-12 px-6 py-12"
          style={{
        ...
        >
          ...
          >
            {/* Categories */}
            <Text className="mb-4 font-bold text-muted text-xs tracking-[1px]">
              CHOOSE YOUR TOPIC
            </Text>
            <View className="mb-8 gap-1">
              {GUIDE_CATEGORIES.map((category) => (
                <Link
                  ...
                  key={category.id}
                >
                  <Pressable className="rounded-lg px-3 py-2.5 hover:bg-hover-surface">
          ...
          <View className="flex-1">
            {/* Header */}
            <Text className="mb-3 font-bold text-[32px] text-foreground">
              Creator Guides & Resources
            </Text>
            <Text
              className="mb-8 text-base text-muted"
              style={{ maxWidth: 600, lineHeight: 24 }}
            >
